...
| 8 | Dan Martell report: 1.16M views, 5/10, "12 claims verified: 4 confirmed, 2 plausible, 3 misleading, 0 false, 3 unverifiable" (Example) | factual | ✅ confirmed | Matches `examples/report-14-ways-to-make-money-with-ai.md` exactly, including the precise view count of 1,164,773 |
| 9 | Second-sun report: 552K views, 9/10 (Example) | factual | ✅ confirmed | Matches `examples/report-second-sun-binary-star.md` |
